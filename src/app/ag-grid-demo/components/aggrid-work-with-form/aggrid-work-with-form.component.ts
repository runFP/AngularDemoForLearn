...
export class AggridWorkWithFormComponent implements OnInit {
  ...
  rowData: any[] = [
    {name: 'LiLei', sex: 'boy', class: '3-1', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
    {name: 'HanMeiMei', sex: 'girl', class: '3-1', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
    {name: 'WuTian', sex: 'girl', class: '3-2', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
    {name: 'WuTian', sex: 'girl', class: '3-2', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
    {name: 'WuTian', sex: 'girl', class: '3-2', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
    {name: 'WuTian', sex: 'girl', class: '3-2', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
    {name: 'WuTian', sex: 'girl', class: '3-2', a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g'},
